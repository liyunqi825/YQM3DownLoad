...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/liyunqi825/YQM3DownLoad.git"
  ...
  s.author             = { "liyunqi" => "623056834@qq.com" }
  # Or just: s.author    = "liyunqi"
  # s.authors            = { "liyunqi" => "623056834@qq.com" }
  ...
  s.source       = { :git => "https://github.com/liyunqi825/YQM3DownLoad.git", :tag => "#{s.version}" }
