...
typedef void(^BNM3U8DownloadOperationResultBlock)( NSError * _Nullable error, NSString * _Nullable relativeUrl,BNM3U8DownloadConfig *cfg);
typedef void(^BNM3U8DownloadOperationProgressBlock)(CGFloat progress,BNM3U8DownloadConfig *cfg);
/*
